  ...
  channels() 
{
  ...
  music = Mix_LoadMUS("sound/yoshida.mp3");
  if (!music) throw string("Couldn't load youshida.mp3")+Mix_GetError();

  startMusic();
  sounds.push_back( Mix_LoadWAV("sound/comedy_throw1.wav") );
  sounds.push_back( Mix_LoadWAV("sound/Comedy_gethoney.wav") );
  sounds.push_back( Mix_LoadWAV("sound/bang.wav") );
