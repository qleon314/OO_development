...
void ExplodingSprite::update(unsigned __int32 ticks) { 
...
void ExplodingSprite::makeChunks(unsigned int n) { 
  ...
  unsigned int chunk_width = std::_Max_value(1u, getFrame()->getWidth()/n);
  unsigned int chunk_height = std::_Max_value(1u, getFrame()->getHeight()/n);
