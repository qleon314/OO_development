...
public:
  ...
  void printgameoverCenteredAt(const string& msg, unsigned __int32 y) const;
  void printStringAfterMessage(const string&, unsigned __int32 x, unsigned __int32 y) const;
